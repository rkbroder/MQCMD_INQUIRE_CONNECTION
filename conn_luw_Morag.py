...
###                args.append(pymqi.CFIL(Parameter=pymqi.CMQCFC.MQBACF_GENERIC_CONNECTION_ID,Values=pymqi.ByteString('')))  
###                args.append(pymqi.CFIL(Parameter=pymqi.CMQCFC.MQIACF_CONN_INFO_TYPE,Values=[pymqi.CMQCFC.MQIACF_CONN_INFO_CONN]))
###                args.append(pymqi.CFIL(Parameter=pymqi.CMQCFC.MQIACF_CONNECTION_ATTRS,Values=[pymqi.CMQCFC.MQCACF_OBJECT_NAME]))
                try:
###
...
###                  conn_handle_response=pcf.MQCMD_INQUIRE_CONNECTION({pymqi.CMQCFC.MQBACF_CONNECTION_ID:conn_id_bytes,
###                  	  pymqi.CMQCFC.MQIACF_CONN_INFO_TYPE:pymqi.CMQCFC.MQIACF_CONN_INFO_HANDLE,
